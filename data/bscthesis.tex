...
\lstset{captionpos=b, numberbychapter=false, basicstyle=\ttfamily, showstringspaces=false, columns=fullflexible, numbers=left, basicstyle=\small}
%% \renewcommand\lstlistingname{kódrészlet}

\newif\ifTDK
\TDKfalse
% \TDKtrue % Comment out to compile thesis.
...
\includepdf[pages=-]{Szakdolgozat_bejelento.pdf}
\newpage

\includepdf{Print/declaration_signed.pdf}
...
\lstinputlisting[language=c++]{handwritten_example.cpp}

The version using our framework is shown below:

\lstinputlisting[language=c++]{mm_example.cpp}
